                ...
                <modal v-if="showModal" @close="showModal = false" key="new-regex-pattern">
                    ...
                    <template v-slot:body>
                        <div class="add-regex-fields">
                            <div>
                                <input type="text" id="regexName" name="regexName" v-model="regexName" placeholder="Pattern Name">
                            </div>
                            <div>
                                <input type="text" id="regexPattern" name="regexPattern" v-model="regexPattern" placeholder="Regex Pattern">
                            </div>
                            <div>
                                <p v-if="errors.length" style="font-size: small;">
                                    <span style="font-weight: 300;">Please correct the following error(s):</span>
                                    <ul>
                                    <li style="font-weight: 200; color: brown;" v-for="error in errors">{{ error }}</li>
                                    </ul>
                                </p>
                            </div>
                        </div>
                    ...
                    <template v-slot:footer>
                        ...
                        <button @click="addRegexPattern" class="primary-btn">{{ RegExIdToEdit >= 0 ? 'Edit' : 'Add' }}</button>
